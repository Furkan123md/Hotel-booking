         ...
         <div className="flex flex-col lg:flex-row mt-6 gap-6">
            ...
            shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
                ...
                <div className="flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500">
                    ...
                    <div className="flex flex-col">
                        ...
                        <input type="date" id="checkInDate" placeholder="Check-In" className="w-full rounded border border-gray-300 px-3 py-2
                        mt-1.5 outline-none required" />
                    </div>
                     <div className="w-px h-15 bg-gray-300/70 max-md:hidden"> </div>
                     <div className="flex flex-col">
                        <label htmlFor="checkOutDate" className="font-medium">Check-Out</label>
                        <input type="date" id="checkOutDate" placeholder="Check-Out" className="w-full rounded border border-gray-300 px-3 py-2
                        mt-1.5 outline-none required" />
                    </div>
                     <div className="w-px h-15 bg-gray-300/70 max-md:hidden"> </div>
                    <div className="flex flex-col">
                ...
                text-white rounded-md max-md:w-full max-md:mt-6 px-25 py-3 md:py-4 text-base cursor-pointer">
                     Check Availability
                </button>
            </form>
            ...
            <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
                <p>Guests will be allocated on the ground floor according to availability.
                    You get a comfortble Two bedroom appartment has a true city feeling.
                    The price quoted is for two guest, at the guest slot please mark the number of
                    guests to get the extact price for groups. The guest will be allocated ground floor
                    according to availability .You get a comfortable two bedroom appartment has a true city feeling.
                </p>
            </div>
